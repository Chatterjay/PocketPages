...
public final class CreativeInventoryController {
    ...
    public static void mousePressedPost(ScreenEvent.MouseButtonPressed.Post event) {
        ...
        if (event.wasClickHandled()) {
            PacketDistributor.sendToServer(ClearPocketPagesInventoryPayload.INSTANCE);
        }
    }
    ...
    public static void applyPage(int row, int unlockedSlots, int sessionId, int requestId,
        ...
        PocketPagesInventoryData.applyClientPage(minecraft.player, row, unlockedSlots, stacks);
