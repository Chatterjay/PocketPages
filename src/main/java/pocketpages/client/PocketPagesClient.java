...
@Mod(value = PocketPages.MODID, dist = Dist.CLIENT)
@EventBusSubscriber(modid = PocketPages.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public final class PocketPagesClient {
    public PocketPagesClient(ModContainer modContainer) {
    ...
    public static void onRegisterScreens(RegisterMenuScreensEvent event) {
        net.minecraft.world.inventory.MenuType<? extends net.minecraft.world.inventory.InventoryMenu> menuType =
                (net.minecraft.world.inventory.MenuType) PocketPages.POCKET_PAGES_MENU.get();
        MenuScreens.ScreenConstructor<net.minecraft.world.inventory.InventoryMenu, ScrollableInventoryScreen> screen =
                (menu, inventory, title) -> new ScrollableInventoryScreen(
                        (pocketpages.inventory.ScrollableInventoryMenu) menu, inventory, title);
