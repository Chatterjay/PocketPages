...
public final class Config {
    ...
    static {
        ...
        TOTAL_EXTRA_SLOTS = BUILDER
                .comment("Total inventory slots managed by PocketPages, excluding the hotbar. Must match between client and server.")
                .translation("pocketpages.configuration.total_extra_slots")
                .defineInRange("totalExtraSlots", 54, 36, 2160);
        START_UNLOCKED_SLOTS = BUILDER
                .comment("Number of PocketPages slots unlocked for new players. Set this to totalExtraSlots to start with every slot unlocked.")
                .translation("pocketpages.configuration.start_unlocked_slots")
        ...
        REQUIRE_EXPERIENCE_TO_UNLOCK = BUILDER
                ...
                .translation("pocketpages.configuration.require_experience_to_unlock")
        ...
        UNLOCK_COST = BUILDER
                ...
                .translation("pocketpages.configuration.unlock_cost")
        ...
        UNLOCK_COST_INCREASE = BUILDER
                ...
                .translation("pocketpages.configuration.unlock_cost_increase")
        ...
        USE_EXPERIENCE_POINTS = BUILDER
                ...
                .translation("pocketpages.configuration.use_experience_points")
        ...
        KEEP_UNLOCKS_ON_DEATH = BUILDER
                ...
                .translation("pocketpages.configuration.keep_unlocks_on_death")
        ...
        LOCKED_ITEM_DROP_CHECK_INTERVAL_TICKS = BUILDER
                ...
                .translation("pocketpages.configuration.locked_item_drop_check_interval_ticks")
        ...
        REMEMBER_CONTAINER_PAGE = BUILDER
                ...
                .translation("pocketpages.configuration.remember_container_page")
        ...
        DEBUG_LOGGING = BUILDER
                ...
                .translation("pocketpages.configuration.debug_logging")
