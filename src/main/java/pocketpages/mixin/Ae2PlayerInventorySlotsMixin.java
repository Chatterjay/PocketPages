...
/** Keeps AE2 terminal menus from treating PocketPages's virtual storage as native player slots. */
@Pseudo
...
abstract class Ae2PlayerInventorySlotsMixin {
    ...
    @Redirect(
            ...
            remap = false)
    private int pocketpages$limitTerminalPlayerSlots(NonNullList<ItemStack> items) {
