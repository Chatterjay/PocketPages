 ...
 * storage slot is PocketPages's stable main-storage index and is {@code -1}
 * outside the main storage. Do not cache either value across a page change.</p>
 */
public record PocketPagesSortingSlot(int menuSlot, int backingInventorySlot,
     ...
     */
    public PocketPagesSortingSlot(int menuSlot, int storageSlot, boolean unlocked) {
