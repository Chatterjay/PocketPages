...
public final class Config {
    ...
    public static final ModConfigSpec.BooleanValue REQUIRE_EXPERIENCE_TO_UNLOCK = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue USE_EXPERIENCE_POINTS = BUILDER
    ...
    public static final ModConfigSpec.BooleanValue REMEMBER_CONTAINER_PAGE = BUILDER
    ...
    public static final ModConfigSpec.IntValue LOCKED_ITEM_DROP_CHECK_INTERVAL_TICKS = BUILDER
